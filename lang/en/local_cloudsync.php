...
$string['cloudrequest'] = 'Request Virtual Machine';
...
$string['terminatevmtitle'] = 'Terminate Virtuale Machine';
...
$string['terminatevmquestion'] = 'Are you sure you want to terminate vm ';
$string['terminatevmwarning'] = 'If you continue you will not be able to access this virtual machine anymore.';
...
$string['activecloudsubscription'] = 'Active Cloud Subscriptions';
$string['selectcloudprovider'] = 'Select cloud provider';
...
$string['vmawaitsdelete'] = 'This VM is awaiting deletion!';
...
$string['vmreqcloudprovider'] ='Cloud Provider: '; 
$string['vmreqsubscription'] ='Subscription: ';
$string['vmreqregion'] ='Region: ';
$string['vmreqidcloud'] ='ID (Cloud): ';
$string['vmreqtype'] ='Type: ';